...
import com.abror.diplom.databinding.ActivityLabsBinding;
...
public class LabsActivity extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener,
        OnPageErrorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.pdfView.fromAsset("labs.pdf")
                .defaultPage(0)
                .onPageChange(this)
                .onLoad(this)
